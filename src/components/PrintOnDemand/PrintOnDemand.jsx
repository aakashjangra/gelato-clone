...
export const PrintOnDemand = () => {
  return <section className="px-32 py-10 grid grid-cols-2 items-center bg-lightPink">
    
    <div className="pr-14">
      <h2 className="font-medium text-lg">For print on demand sellers</h2>
      <h3 className="py-3 font-semibold text-6xl tracking-tighter leading-tight">Accelerate business growth with innovative design tools and apps</h3>
